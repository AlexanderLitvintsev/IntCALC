...
Преобразует матрицу к имеющей те же собственные значения (но другие
собственные вектора), и меньшую норму.

Входные данные:
    a - матрица с нумерацией [1..n, 1..n]
    n - размер матрицы

Выходные данные:
    a - отбалансированная матрица
    d - диагональная матрица преобразования подобия, использованного
        для балансировки (A' = D^(-1)*A*D).
